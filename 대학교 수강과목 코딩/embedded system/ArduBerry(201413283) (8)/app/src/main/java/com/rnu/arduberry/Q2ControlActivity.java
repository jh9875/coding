...
public class Q2ControlActivity extends Activity
{
    //------------------------------------------------------------------------
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "Q2ControlActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.q2_layout);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(Q2ControlActivity.this);
