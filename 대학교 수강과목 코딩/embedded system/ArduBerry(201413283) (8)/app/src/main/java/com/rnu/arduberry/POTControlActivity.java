...
public class POTControlActivity  extends Activity
{
    ...
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "POTControlActivity";
  ...
  //  private ImageView 				mIvPhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.potentionmeter_layout);
    ...
    private void initUI(){
        ...
        mPot 		= findViewById(R.id.potText);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(POTControlActivity.this);
