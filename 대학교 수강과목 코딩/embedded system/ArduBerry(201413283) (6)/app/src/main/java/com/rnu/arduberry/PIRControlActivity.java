...
public class PIRControlActivity extends Activity
{
    //------------------------------------------------------------------------
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "PIRControlActivity";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(PIRControlActivity.this);
