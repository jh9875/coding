...
public class MOTERControlActivity extends Activity
{
    //------------------------------------------------------------------------
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "MOTERControlActivity";
    ...
    //private Button mPlusBTN, mMinusBTN, mStopBTN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.moter_layout);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(MOTERControlActivity.this);
