...
public class LCDControlActivity extends Activity
{
    //------------------------------------------------------------------------
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "LCDControlActivity";
    ...
    public void clickFunc(View v) {
        ...
        switch(v.getId())
        {
            ...
            case R.id.sendButton:
                String sendMs ="@LCD,3" +mInputText.getText() +"#";
                sendMessage(sendMs);
                break;
        }
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(LCDControlActivity.this);
